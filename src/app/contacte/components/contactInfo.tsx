...
export default function ContactInfo() {
    return (
        <div className="relative mt-10 flex gap-6 justify-center text-start">
            <div>
                <h4 className="font-semibold">Adreça</h4>
                <p className="text-sm text-gray-700">Ronda de Ponent, 2, Local, 08201, Sabadell, Barcelona</p>
            </div>

            <div>
                <h4 className="font-semibold">Correu electrónic</h4>
                <p className="text-sm text-gray-700">info@enttia.com</p>
            </div>
            <div>
                <h4 className="font-semibold">Telèfon</h4>
